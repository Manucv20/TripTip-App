  ...
  <header style={{ 
    ...
    <SearchComponent />
      ...
      <main style={{ textAlign: "center" }}>
        ...
        <p>¿Quieres viajar de forma más auténtica y responsable? Vive experiencias únicas junto con nuestros expertos y expertas locales, y descubre nuestros consejos y recomendaciones para viajar de forma respetuosa con el entorno y la cultural local. Aquí tienes algunos ejemplos:</p>
